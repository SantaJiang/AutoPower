#ifndef MINICALENDARITEM_H
#define MINICALENDARITEM_H

#include <QWidget>
#include <QDate>

class MiniCalendarItem : public QWidget
{
    Q_OBJECT
    Q_ENUMS(DayType)
    Q_ENUMS(SelectType)
...
public:
    ...
    explicit MiniCalendarItem(QWidget *parent = 0);
...
Q_SIGNALS:
    void clicked(const QDate &date, const MiniCalendarItem::DayType &dayType);
};

#endif // MINICALENDARITEM_H
